...
/// Information about commands run by a specific user.
#[derive(Debug, Clone)]
...
impl AppState {
    ...
    pub fn new(config: &AppConfig) -> Self {
        ...
        let os_version = sysinfo::System::os_version().unwrap_or_else(|| "".into());
    ...
    /// Mark os_version as read to avoid dead_code warning if necessary.
